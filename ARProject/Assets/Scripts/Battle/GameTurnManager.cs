...
public class GameTurnManager : PunBehaviour
{
    ...
    public void SendMove(object move,object element, bool finished)
    {
        if (IsFinishedByMe)
        {
            ...
            case EvFinalMove:
                {
                    ...
                    if (turn == this.Turn)
                    {
                        ...
                        this.TurnManagerListener.OnPlayerFinished(sender, turn, move, element);
...
public interface IMyTurnManagerCallbacks
{
    ...
    void OnPlayerMove(PhotonPlayer player, int turn, object move,object elementchoice);

    void OnPlayerFinished(PhotonPlayer player, int turn, object move,object elementchoice);
