...
public class Buttonmanager : Singleton<Buttonmanager>
{
    ...
    public void gotoCreatsecene()
    {
        ...
        Invoke("PlayerCreateceneload", 1f);
    }
    void PlayerCreateceneload()
    {
    ...
    #endregion
    #region Lobby
    public void ActiveItemPanel()
    {
        GameManager.Inst.Scenestack.Push("Item");
        MainManager.Inst.ItemPanel.SetActive(true);
    }
    #endregion
    #region inventory
    ...
    {
        GameManager.Inst.Scenestack.Push("ToolBox");
        MainManager.Inst.ItemPanel.SetActive(true);
    }
    public void DeactiveToolboxpanel()
    {
        MainManager.Inst.ItemPanel.SetActive(false);
    }
    #endregion
